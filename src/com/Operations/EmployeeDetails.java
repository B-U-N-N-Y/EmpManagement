...
public class EmployeeDetails {
	...
	public EmployeeDetails(String emp_name, int emp_id, double emp_salary, String emp_department, int emp_age, String emp_address,
			String emp_gender, String emp_skills) {
